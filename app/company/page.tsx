...
import CompanyPageClient from './company-client'; // Default import (no braces)

// --- SEO METADATA FOR /company ---
export const metadata: Metadata = {
  title: 'About SSS Defence | Our Company, DNA, and "Born in Bharat" Mission',
  description: 'Founded in 2017, SSS Defence is a new breed of innovation dedicated to meeting the specific requirements of Armed Forces and Law Enforcement agencies.',
  openGraph: {
    title: 'About SSS Defence | Our Company & Mission',
    description: 'Learn about our commitment to quality, innovation, and "Atmanirbhar Bharat".',
    images: ['/Company/Company_Hero.png'], 
  },
};
// ---------------------------------

// This is the new Server Component for the /company route
