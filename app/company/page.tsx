...
// // ✅ 1. Import AnimatePresence for tab content transitions
...
// // ✅ 2. --- TAB DATA (UPDATED) ---
// // All content here has been replaced with your provided text.
// const tabData = [
//   {
//     id: 'about',
//     title: 'ABOUT US',
...
//         </p>
//         {/* Formatted the in-line list for better readability */}
...
//     content: (
//       <div className="space-y-4">
//         {/* Updated the h3 title as requested */}
//         <h3 className="text-2xl md:text-3xl font-bold text-white mb-4">CHAIRMAN & MANAGING DIRECTOR DESK</h3>
//         <p className="text-gray-300 leading-relaxed">
//           SSS Defence was born with the mission of being a 21st century defence R&D and manufacturing enterprise, striving to give our military and law enforcement the next generation of tools and equipment. Our mission is focused on developing products that are purpose designed and duty built to meet or exceed demanding challenges they face in this dangerous world. 
//         </p>
//         <p className="text-gray-300 leading-relaxed">
//           Over the past 7 years, we have indigenously designed and manufactured a range of small arms systems that match global benchmarks. When asked if our products are truly "Made in India,"we proudly respond - our systems are "“Born in Bharat." As we continue to prove that Bharat can leapfrog the world in firearms technology despite the private sector starting several years behind, we also do accept that the journey is long & arduous. That listening to our customers & constant innovation is key to building a reputation as a premier international OEM in our chosen space. We thank you for being a part of our growth story & supporting our mission. 
//         </p>
//         <p className="text-gray-300 font-semibold leading-relaxed">
//           Jai Hind 
//         </p>
//         {/* Formatted the sign-off block */}
//         <div className="text-gray-300 font-semibold mt-2 leading-tight">
//           <p>Satish Machani</p>
...
//   // ✅ 3. Add state to track the active tab, defaulting to the first tab's id
...
//         {/* ✅ 4. --- TAB SECTION (Unchanged) --- */}
//         <section className="container mx-auto px-4 py-16 lg:py-24 relative z-10">
//           {/* Tab Buttons */}
//           <div className="flex flex-wrap justify-center gap-x-4 gap-y-2 md:gap-x-8 lg:gap-x-12 border-b border-gray-700/50 mb-12">
//             {tabData.map((tab) => (
//               <button
//                 key={tab.id}
//                 onClick={() => setActiveTab(tab.id)}
//                 className={`relative uppercase font-black tracking-wider text-sm md:text-base py-3 px-2 transition-colors duration-300 ease-in-out focus:outline-none ${
//                   activeTab === tab.id ? 'text-white' : 'text-gray-500 hover:text-gray-200'
//                 }`}
//                 style={{ WebkitTapHighlightColor: 'transparent' }} // Removes tap highlight on mobile
//               >
//                 {tab.title}
//                 {/* Animated underline for active tab */}
//                 {activeTab === tab.id && (
//                   <motion.div
//                     className="absolute bottom-[-1px] left-0 right-0 h-1 bg-red-600"
//                     layoutId="underline" // This creates the sliding animation
...
//     content: (
//       <div className="space-y-4">
//         <h3 className="text-2xl md:text-3xl 2xl:text-4xl font-bold text-white mb-4">CHAIRMAN & MANAGING DIRECTOR DESK</h3>
//         <p className="text-gray-300 leading-relaxed">
//           SSS Defence was born with the mission of being a 21st century defence R&D and manufacturing enterprise, striving to give our military and law enforcement the next generation of tools and equipment. Our mission is focused on developing products that are purpose designed and duty built to meet or exceed demanding challenges they face in this dangerous world. 
//         </p>
//         <p className="text-gray-300 leading-relaxed">
...
//         {/* MODERN TAB SECTION */}
//         <section className="container mx-auto px-4 py-16 lg:py-24 relative z-10">
//           {/* Tab Buttons with Modern Glass Design */}
//           <div className="relative max-w-6xl mx-auto mb-16">
//             {/* Glowing background effect (Unchanged) */}
//             <motion.div
...
//                     activeTab === tab.id 
//                       ? 'text-white shadow-2xl shadow-red-600/20' 
...
//                       className="absolute inset-0 bg-gradient-to-br from-red-600 via-red-700 to-red-900 rounded-xl"
...
//                   {activeTab !== tab.id && (
//                     <motion.div
//                       className="absolute inset-0 bg-gradient-to-br from-white/[0.03] to-white/[0.01] rounded-xl opacity-0 group-hover:opacity-100"
...
//                   }}
//                   onClick={() => setActiveTab(tab.id)}
//                   // ✅ MODIFIED: Removed the bright red shadow from the active class
//                   className={`relative flex-shrink-0 uppercase font-black tracking-wider text-xs md:text-sm lg:text-base 2xl:text-lg py-4 px-6 md:px-8 rounded-xl transition-all duration-500 ease-out focus:outline-none group overflow-hidden ${
//                     activeTab === tab.id 
//                       ? 'text-white' // Shadow removed
//                       : 'text-gray-400 hover:text-gray-200'
//                   }`}
//                   style={{ WebkitTapHighlightColor: 'transparent' }}
//                   initial={{ opacity: 0, y: 20 }}
...
//                   whileTap={{ scale: 0.98 }}
//                 >
//                   {/* ✅ MODIFIED: Active background is now a dark, glassy red with a border */}
//                   {activeTab === tab.id && (
//                     <motion.div
//                       layoutId="activeBackground"
...
//                   {/* ✅ MODIFIED: Hover background is now a simple, clean glass effect */}
//                   {activeTab !== tab.id && (
//                     <motion.div
...
//                   {/* Scanning line effect (Unchanged) */}
//                   {activeTab === tab.id && (
//                     <motion.div
//                       className="absolute inset-0 overflow-hidden rounded-xl"
//                       initial={false}
...
const tabData = [
  ...
  // Removed the 'director' object that was here
];
